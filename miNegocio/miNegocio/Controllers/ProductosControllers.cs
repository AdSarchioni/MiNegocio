...
{
    public class ProductosControllers : Controller
    {
        private readonly RepositorioProductos _repositorioProductos;
        private readonly IWebHostEnvironment _environment;
        // Constructor que inyecta el repositorio
        public ProductosControllers(RepositorioProductos repositorioProductos, IWebHostEnvironment environment)
        {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            return View(productos);  // Pasamos l|a lista de productos a la vista
        }
